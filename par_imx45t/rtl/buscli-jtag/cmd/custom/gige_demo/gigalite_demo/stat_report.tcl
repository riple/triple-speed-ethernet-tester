...
proc createReport {} {
    ...
    pack .report.bottom.f3 .report.bottom.f4 .report.bottom.f5 -side left
...
proc listReport {{rowNum 16}} {
    ...
    for {set i 0} {$i<[llength [stream_define_dout]]} {incr i} {
        #set i [.report.top.nb index [.report.top.nb raise]]
...
proc buildReadStatisticResults {} {
    package require BWidget
    source gigalite_demo/stat_report_para.tcl
