...
wm title .flow "Test Flow"
    ...
    set no_hardware 1
    # set port num 0 or 1
    checkbutton .flow.portnum1 -text {Select Port 1} -variable port_num
    global port_num
    set port_num 0
    ...
    # build "Read Statistic Results" button
    button .flow.exitdemo -text {Exit Demo} -command {ExitDemo}
    # 
    pack .flow.nohardware .flow.portnum1 .flow.space \
